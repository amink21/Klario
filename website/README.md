# Klario promotional website

Simple static site to promote the Klario app. Same theme as the mobile app (off-white background, pastel green accent). Footer is green with rounded top corners.
...
- **faq.html** – Full FAQ (what is Klario, reminders, import, spending, subscriptions, free plan, data, sync, clear data, notifications, categories, contact)
